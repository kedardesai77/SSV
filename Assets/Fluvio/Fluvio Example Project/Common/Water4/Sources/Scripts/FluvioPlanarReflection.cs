...
[AddComponentMenu("Fluvio Example Project/Water4/Planar Reflection")]
public class FluvioPlanarReflection : MonoBehaviour 
{	
	// reflection
	...
	public void Start () 
	{
		sharedMaterial = ((FluvioWaterBase)gameObject.GetComponent(typeof(FluvioWaterBase))).sharedMaterial;
	}
