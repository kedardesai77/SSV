...
public class ColorPicker : MonoBehaviour {
	...
	public List<GameObject> receiver;
    ...
    public static bool openCondition = false;
	...
	void Start()
	{
        ...
        foreach(GameObject rgo in receiver)
		{
			rgo.SendMessage(colorGetFunctionName, this, SendMessageOptions.DontRequireReceiver);
		}
	}
	...
	public void _DrawGUI () 
	{
        ...
        //GUI.DrawTexture(new Rect(startPos.x , startPos.y - 40, 40, 20), txColorDisplay);
		...
		if(mState == ESTATE.Showed)
		{
			...
			if(GUI.Button(new Rect(startPos.x + sizeCurr + 10, startPos.y + 150, 60, 20), "Apply"))
			{
				...
				foreach(GameObject rgo in receiver)
				{
					rgo.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
				}
			}
