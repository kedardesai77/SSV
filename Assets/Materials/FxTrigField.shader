...
#pragma exclude_renderers d3d11 xbox360
			...
			struct v2f { float4 pos : SV_POSITION; float4 texcoord : TEXCOORD0; float4[4] target : TEXCOORD1; };
	
			v2f vert (appdata_base v) { v2f o; o.pos = mul (UNITY_MATRIX_MVP, v.vertex); o.texcoord = v.texcoord; int j; for ( j = 2; j < 5; j++) { float a, b; sincos(j*_Time[0], a, b); o.target[j-2] = float4(a, b, 0, 0); } return o; }
		...
		} // for return half4( (dot(d, d) * _Color).xyz, 1 ); 
			ENDCG
	}
